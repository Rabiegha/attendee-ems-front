...
interface FormPreviewProps {
  event: EventDPO
  fields: FormField[]
  functional?: boolean // Si true, le formulaire est fonctionnel (soumission réelle)
  submitButtonText?: string
  submitButtonColor?: string
  showTitle?: boolean
  showDescription?: boolean
  isDarkMode?: boolean
  onSuccess?: () => void // Callback après inscription réussie
}
...
export const FormPreview: React.FC<FormPreviewProps> = ({
  ...
  const renderField = (field: FormField) => {
    ...
    // Si fieldType existe, l'utiliser, sinon utiliser field.type (pour les anciens champs)
