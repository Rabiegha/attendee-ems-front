...
La demande initiale de l'utilisateur : *"sur tous les tableau, j'aimerais qu'il soit possible de séléctionner plusieurs element d'un coup afin de réaliser des actions rapide"* est maintenant **réalisée à 66%** (2/3 modules) avec une base solide pour compléter rapidement le module Registrations.
