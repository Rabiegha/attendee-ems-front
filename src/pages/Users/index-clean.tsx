/**
 * EXEMPLE REFACTORISÃ‰ - UsersPage
 *
 * Ce fichier dÃ©montre l'utilisation des nouveaux composants du design system:
 * - PageContainer pour le layout de base
 * - PageHeader pour l'en-tÃªte avec actions
 * - PageSection pour les sections de contenu
 * - Card pour les cartes de statistiques
 * - ActionGroup pour grouper les boutons
 *
 * Comparez avec src/pages/Users/index.tsx pour voir les amÃ©liorations
 */
...
export function UsersPageRefactored() {
  ...
  return (
    <PageContainer maxWidth="7xl" padding="lg">
      {/* En-tÃªte de page avec nouveau composant PageHeader */}
      <PageHeader
