...
export const PartnerSelect: React.FC<PartnerSelectProps> = ({
  ...
  if (isLoading) {
    return (
      <div className={`min-h-[42px] border border-gray-300 rounded-lg p-3 bg-gray-50 ${className}`}>
  ...
  if (error) {
    return (
      <div className={`min-h-[42px] border border-red-300 rounded-lg p-3 bg-red-50 ${className}`}>
