...
const mockEvents = [ /* 100+ lignes de fake data */ ]
```
...
**Tab Inscriptions (Event Details) :**
8. ⏳ **Voir les inscrits** → Doit afficher les registrations créées par le seeder
9. ⏳ **Approve/Refuse inscription** → Tester `useUpdateRegistrationStatusMutation()`
10. ⏳ **Filtrer par statut** (awaiting, approved, refused, cancelled)
