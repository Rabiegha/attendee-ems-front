...
const TEST_ACCOUNTS: TestAccount[] = [
  // === SUPER ADMIN - Accès global omniscient ===
  {
    ...
    orgSlug: 'acme-corp',
    description:
      'Super Admin omniscient - Accès global à toutes organisations et fonctionnalités',
      ...
      <div className="relative p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            Base de données réelle - Utilisez ces comptes pour tester
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 max-h-96 overflow-y-auto">
            {filteredAccounts.map((account, index) => (
              <div
                key={index}
                className="border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
              >
                <div className="flex items-start justify-between">
...

                      {
                        <div className="flex items-center space-x-2">
                          ...
                          <Button
                            ...
                            variant="secondary"
                            onClick={() =>
                              copyToClipboard(account.password, 'Mot de passe')
                            }
                          >
                            <Copy className="h-3 w-3" />
                          </Button>
                  ...
                  <div className="flex flex-col items-end space-y-2">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${ROLE_COLORS[account.role] || 'bg-gray-100 text-gray-800'}`}
                    >
                      {account.role}
                    </span>
                    <Button
