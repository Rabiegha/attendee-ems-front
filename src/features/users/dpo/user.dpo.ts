...
export const createUserSchema = z.object({
  ...
  role_id: z.string().uuid('ID de rôle invalide').min(1, 'Rôle requis'),
...
export const createUserWithGeneratedPasswordSchema = z.object({
  ...
  createNewOrg: z.boolean().optional().default(false),

  newOrgName: z.string().optional(),

  newOrgSlug: z.string().optional(),
...
export type CreateUserWithGeneratedPasswordFormData = z.infer<
  typeof createUserWithGeneratedPasswordSchema
>
