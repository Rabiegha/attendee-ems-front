 ...
 * 
 * Input autocomplete pour sélectionner plusieurs tags
 * Affiche les tags sélectionnés sous forme de chips
 */
...
export const TagMultiSelect: React.FC<TagMultiSelectProps> = ({
  ...
  const suggestions = allTags.filter(tag => !value.includes(tag.name))
    ...
    switch (e.key) {
      ...
      case 'Enter':
        ...
        if (suggestions[activeSuggestionIndex]) {
          handleAddTag(suggestions[activeSuggestionIndex].name)
        }
        break
