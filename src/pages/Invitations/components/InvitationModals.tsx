  ...
  <Modal isOpen={isOpen} onClose={onClose} title="" maxWidth="md">
    <div className="text-center py-6">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        L'utilisateur va recevoir un email avec un lien sécurisé pour créer son compte.
...
export const ErrorModal: React.FC<ErrorModalProps> = ({ isOpen, onClose, title, message, type }) => (
  <Modal isOpen={isOpen} onClose={onClose} title="" maxWidth="md">
    <div className="text-center py-6">
      ...
      <Button onClick={onClose} variant={type === 'error' ? 'destructive' : 'default'} className="w-full">
        Compris
      </Button>
    </div>
  </Modal>
...
export const UserExistsModal: React.FC<UserExistsModalProps> = ({ isOpen, onClose, email }) => (
  <Modal isOpen={isOpen} onClose={onClose} title="" maxWidth="md">
    <div className="text-center py-6">
